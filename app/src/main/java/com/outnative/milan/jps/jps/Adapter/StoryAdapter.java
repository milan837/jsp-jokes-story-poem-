...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.MyViewHolder> {
    ...
    Context ctx;
    Typeface typeface;
    public StoryAdapter(Context context,List list) {
        this.list=list;
        this.ctx=context;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final StoryRows rows=(StoryRows)list.get(position);
        ...
        holder.linearLayout.setBackgroundDrawable(ctx.getResources().getDrawable(R.drawable.pattern2));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemHolder) {
            super(itemHolder);
            this.linearLayout=(LinearLayout)itemHolder.findViewById(R.id.main_adapter_item_story);
            this.body=(TextView)itemHolder.findViewById(R.id.adapter_story_body);
            this.title=(TextView)itemHolder.findViewById(R.id.adapter_story_title);
            this.likes=(TextView)itemHolder.findViewById(R.id.adapter_story_likes);
            this.views=(TextView)itemHolder.findViewById(R.id.adapter_story_view);
            this.username=(TextView)itemHolder.findViewById(R.id.adapter_story_author);
            this.post_id=(TextView)itemHolder.findViewById(R.id.adapter_story_post_id);
        }
    }
}
