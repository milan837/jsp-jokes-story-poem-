...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.adapter_jokes,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final PostRows rows=(PostRows)list.get(position);
        ...
        holder.linearLayout.setBackgroundDrawable(ctx.getResources().getDrawable(R.drawable.pattern4));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemHolder) {
            super(itemHolder);
            this.linearLayout=(LinearLayout)itemHolder.findViewById(R.id.main_adapter_item);
            this.body=(TextView)itemHolder.findViewById(R.id.adapter_jokes_body);
            this.title=(TextView)itemHolder.findViewById(R.id.adapter_jokes_title);
            this.likes=(TextView)itemHolder.findViewById(R.id.adapter_jokes_likes);
            this.views=(TextView)itemHolder.findViewById(R.id.adapter_jokes_view);
            this.username=(TextView)itemHolder.findViewById(R.id.adapter_jokes_author);
            this.post_id=(TextView)itemHolder.findViewById(R.id.adapter_jokes_post_id);
        }
    }
}
